...
import mc.minecraft.data.game.entity.attribute.ModifierType;
import mc.minecraft.data.game.entity.metadata.MetadataType;
import mc.minecraft.data.game.entity.player.*;
import mc.minecraft.data.game.entity.type.GlobalEntityType;
import mc.minecraft.data.game.entity.type.MobType;
import mc.minecraft.data.game.entity.type.PaintingType;
import mc.minecraft.data.game.entity.type.object.HangingDirection;
import mc.minecraft.data.game.entity.type.object.MinecartType;
import mc.minecraft.data.game.entity.type.object.ObjectType;
import mc.minecraft.data.game.scoreboard.*;
import mc.minecraft.data.game.setting.ChatVisibility;
import mc.minecraft.data.game.setting.Difficulty;
import mc.minecraft.data.game.statistic.Achievement;
import mc.minecraft.data.game.statistic.GenericStatistic;
import mc.minecraft.data.game.window.*;
import mc.minecraft.data.game.window.property.AnvilProperty;
import mc.minecraft.data.game.window.property.BrewingStandProperty;
import mc.minecraft.data.game.window.property.EnchantmentTableProperty;
import mc.minecraft.data.game.window.property.FurnaceProperty;
import mc.minecraft.data.game.world.Particle;
import mc.minecraft.data.game.world.WorldBorderAction;
...
import mc.minecraft.data.game.world.effect.ParticleEffect;
import mc.minecraft.data.game.world.effect.SmokeEffectData;
import mc.minecraft.data.game.world.effect.SoundEffect;
import mc.minecraft.data.game.world.map.MapIconType;
import mc.minecraft.data.game.world.notify.ClientNotification;
import mc.minecraft.data.game.world.notify.DemoMessageValue;
import mc.minecraft.data.game.world.notify.EnterCreditsValue;
import mc.minecraft.data.game.world.sound.BuiltinSound;
import mc.minecraft.data.game.world.sound.SoundCategory;
