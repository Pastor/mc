package mc.minecraft.packet.ingame.server.window;

import mc.api.Buffer;
import mc.api.Packet;
import mc.minecraft.data.game.window.WindowType;
...
public class ServerOpenWindowPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.type = mc.minecraft.Magic.key(WindowType.class, in.readString());
