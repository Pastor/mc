...
import mc.minecraft.data.game.world.map.MapData;
import mc.minecraft.data.game.world.map.MapIcon;
...
public class ServerMapDataPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        for (int index = 0; index < this.icons.length; index++) {
            ...
            this.icons[index] = new MapIcon(x, z, mc.minecraft.Magic.value(MapIconType.class, type), rotation);
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        for (int index = 0; index < this.icons.length; index++) {
            ...
            int type = mc.minecraft.Magic.key(Integer.class, icon.getIconType());
