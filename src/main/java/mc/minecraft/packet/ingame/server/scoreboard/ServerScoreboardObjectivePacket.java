...
import mc.minecraft.data.game.scoreboard.ObjectiveAction;
import mc.minecraft.data.game.scoreboard.ScoreType;
...
public class ServerScoreboardObjectivePacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minecraft.Magic.key(ObjectiveAction.class, in.readByte());
        if (this.action == ObjectiveAction.ADD || this.action == ObjectiveAction.UPDATE) {
            this.displayName = in.readString();
            this.type = mc.minecraft.Magic.key(ScoreType.class, in.readString());
        }
    }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == ObjectiveAction.ADD || this.action == ObjectiveAction.UPDATE) {
            ...
            out.writeString(mc.minecraft.Magic.value(String.class, this.type));
        }
    }
