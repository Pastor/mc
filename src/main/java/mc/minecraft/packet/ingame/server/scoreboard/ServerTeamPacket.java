...
import mc.minecraft.data.game.scoreboard.CollisionRule;
import mc.minecraft.data.game.scoreboard.NameTagVisibility;
import mc.minecraft.data.game.scoreboard.TeamAction;
import mc.minecraft.data.game.scoreboard.TeamColor;
...
public class ServerTeamPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minecraft.Magic.key(TeamAction.class, in.readByte());
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            this.nameTagVisibility = mc.minecraft.Magic.key(NameTagVisibility.class, in.readString());
            this.collisionRule = mc.minecraft.Magic.key(CollisionRule.class, in.readString());
            this.color = mc.minecraft.Magic.key(TeamColor.class, in.readByte());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            out.writeString(mc.minecraft.Magic.value(String.class, this.nameTagVisibility));
            out.writeString(mc.minecraft.Magic.value(String.class, this.collisionRule));
            out.writeByte(mc.minecraft.Magic.value(Integer.class, this.color));
        }
