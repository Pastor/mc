...
import mc.minecraft.data.game.BossBarAction;
import mc.minecraft.data.game.BossBarColor;
import mc.minecraft.data.game.BossBarDivision;
...
public class ServerBossBarPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minecraft.Magic.key(BossBarAction.class, in.readVarInt());
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            this.color = mc.minecraft.Magic.key(BossBarColor.class, in.readVarInt());
            this.division = mc.minecraft.Magic.key(BossBarDivision.class, in.readVarInt());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            out.writeVarInt(mc.minecraft.Magic.value(Integer.class, this.color));
            out.writeVarInt(mc.minecraft.Magic.value(Integer.class, this.division));
        }
