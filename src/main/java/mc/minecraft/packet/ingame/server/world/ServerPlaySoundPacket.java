...
import mc.minecraft.data.game.world.sound.CustomSound;
import mc.minecraft.data.game.world.sound.Sound;
...
public class ServerPlaySoundPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        try {
            this.sound = mc.minecraft.Magic.key(BuiltinSound.class, value);
        } catch (IllegalArgumentException e) {
            this.sound = new CustomSound(value);
        }

        this.category = mc.minecraft.Magic.key(SoundCategory.class, in.readVarInt());
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.sound instanceof CustomSound) {
            ...
            value = mc.minecraft.Magic.value(String.class, this.sound);
        }

        out.writeString(value);
        out.writeVarInt(mc.minecraft.Magic.value(Integer.class, this.category));
