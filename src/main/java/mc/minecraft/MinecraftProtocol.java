...
import mc.minecraft.packet.ingame.client.window.*;
import mc.minecraft.packet.ingame.client.world.*;
import mc.minecraft.packet.ingame.server.*;
import mc.minecraft.packet.ingame.server.entity.*;
import mc.minecraft.packet.ingame.server.entity.player.*;
import mc.minecraft.packet.ingame.server.entity.spawn.*;
import mc.minecraft.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import mc.minecraft.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import mc.minecraft.packet.ingame.server.scoreboard.ServerTeamPacket;
import mc.minecraft.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import mc.minecraft.packet.ingame.server.window.*;
import mc.minecraft.packet.ingame.server.world.*;
