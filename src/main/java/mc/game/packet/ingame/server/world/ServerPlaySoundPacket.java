...
import mc.game.data.game.world.sound.CustomSound;
import mc.game.data.game.world.sound.Sound;
...
public class ServerPlaySoundPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        try {
            this.sound = mc.game.Magic.key(BuiltinSound.class, value);
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.sound instanceof CustomSound) {
            ...
            value = mc.game.Magic.value(String.class, this.sound);
        }
