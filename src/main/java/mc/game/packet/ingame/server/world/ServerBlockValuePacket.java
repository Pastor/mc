...
public class ServerBlockValuePacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        if (this.blockId == NOTE_BLOCK) {
            this.type = mc.game.Magic.key(NoteBlockValueType.class, type);
            this.value = new NoteBlockValue(value);
        } else if (this.blockId == STICKY_PISTON || this.blockId == PISTON) {
            this.type = mc.game.Magic.key(PistonValueType.class, type);
            this.value = mc.game.Magic.key(PistonValue.class, value);
        } else if (this.blockId == MOB_SPAWNER) {
            this.type = mc.game.Magic.key(MobSpawnerValueType.class, type);
            ...
            this.type = mc.game.Magic.key(ChestValueType.class, type);
            this.value = new ChestValue(value);
        } else {
            this.type = mc.game.Magic.key(GenericBlockValueType.class, type);
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.type instanceof NoteBlockValueType) {
            type = mc.game.Magic.value(Integer.class, (NoteBlockValueType) this.type);
        } else if (this.type instanceof PistonValueType) {
            type = mc.game.Magic.value(Integer.class, (PistonValueType) this.type);
        } else if (this.type instanceof MobSpawnerValueType) {
            type = mc.game.Magic.value(Integer.class, (MobSpawnerValueType) this.type);
        } else if (this.type instanceof ChestValueType) {
            type = mc.game.Magic.value(Integer.class, (ChestValueType) this.type);
        } else if (this.type instanceof GenericBlockValueType) {
            type = mc.game.Magic.value(Integer.class, (GenericBlockValueType) this.type);
        }
        ...
        if (this.value instanceof NoteBlockValue) {
            ...
            val = mc.game.Magic.value(Integer.class, (PistonValue) this.value);
