...
import mc.game.data.game.statistic.*;
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        for (int index = 0; index < length; index++) {
            ...
            if (value.startsWith("achievement.")) {
                statistic = mc.game.Magic.key(Achievement.class, value);
                ...
                statistic = mc.game.Magic.key(GenericStatistic.class, value);
            }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        for (Statistic statistic : this.statistics.keySet()) {
            ...
            if (statistic instanceof Achievement) {
                value = mc.game.Magic.value(String.class, (Achievement) statistic);
                ...
                value = mc.game.Magic.value(String.class, (GenericStatistic) statistic);
            }
