...
import mc.game.data.game.scoreboard.CollisionRule;
import mc.game.data.game.scoreboard.NameTagVisibility;
import mc.game.data.game.scoreboard.TeamAction;
import mc.game.data.game.scoreboard.TeamColor;
...
public class ServerTeamPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.game.Magic.key(TeamAction.class, in.readByte());
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            this.nameTagVisibility = mc.game.Magic.key(NameTagVisibility.class, in.readString());
            this.collisionRule = mc.game.Magic.key(CollisionRule.class, in.readString());
            this.color = mc.game.Magic.key(TeamColor.class, in.readByte());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            out.writeString(mc.game.Magic.value(String.class, this.nameTagVisibility));
            out.writeString(mc.game.Magic.value(String.class, this.collisionRule));
            out.writeByte(mc.game.Magic.value(Integer.class, this.color));
        }
