...
import mc.game.data.game.BossBarAction;
import mc.game.data.game.BossBarColor;
import mc.game.data.game.BossBarDivision;
...
public class ServerBossBarPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.game.Magic.key(BossBarAction.class, in.readVarInt());
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            this.color = mc.game.Magic.key(BossBarColor.class, in.readVarInt());
            this.division = mc.game.Magic.key(BossBarDivision.class, in.readVarInt());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            out.writeVarInt(mc.game.Magic.value(Integer.class, this.color));
            out.writeVarInt(mc.game.Magic.value(Integer.class, this.division));
        }
