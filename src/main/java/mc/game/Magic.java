...
import mc.game.data.game.entity.attribute.AttributeType;
import mc.game.data.game.entity.attribute.ModifierOperation;
import mc.game.data.game.entity.attribute.ModifierType;
import mc.game.data.game.entity.metadata.MetadataType;
import mc.game.data.game.entity.player.*;
import mc.game.data.game.entity.type.GlobalEntityType;
import mc.game.data.game.entity.type.MobType;
import mc.game.data.game.entity.type.PaintingType;
import mc.game.data.game.entity.type.object.HangingDirection;
import mc.game.data.game.entity.type.object.MinecartType;
import mc.game.data.game.entity.type.object.ObjectType;
import mc.game.data.game.scoreboard.*;
import mc.game.data.game.setting.ChatVisibility;
import mc.game.data.game.setting.Difficulty;
import mc.game.data.game.statistic.Achievement;
import mc.game.data.game.statistic.GenericStatistic;
import mc.game.data.game.window.*;
import mc.game.data.game.window.property.AnvilProperty;
import mc.game.data.game.window.property.BrewingStandProperty;
import mc.game.data.game.window.property.EnchantmentTableProperty;
import mc.game.data.game.window.property.FurnaceProperty;
import mc.game.data.game.world.Particle;
import mc.game.data.game.world.WorldBorderAction;
...
import mc.game.data.game.world.block.value.*;
import mc.game.data.game.world.effect.ParticleEffect;
import mc.game.data.game.world.effect.SmokeEffectData;
import mc.game.data.game.world.effect.SoundEffect;
import mc.game.data.game.world.map.MapIconType;
import mc.game.data.game.world.notify.ClientNotification;
import mc.game.data.game.world.notify.DemoMessageValue;
import mc.game.data.game.world.notify.EnterCreditsValue;
