...
import mc.game.packet.ingame.client.*;
import mc.game.packet.ingame.client.player.*;
import mc.game.packet.ingame.client.window.*;
import mc.game.packet.ingame.client.world.*;
import mc.game.packet.ingame.server.*;
import mc.game.packet.ingame.server.entity.*;
import mc.game.packet.ingame.server.entity.player.*;
import mc.game.packet.ingame.server.entity.spawn.*;
import mc.game.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import mc.game.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import mc.game.packet.ingame.server.scoreboard.ServerTeamPacket;
import mc.game.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import mc.game.packet.ingame.server.window.*;
import mc.game.packet.ingame.server.world.*;
...
import mc.impl.DefaultPacket;
import mc.impl.EncryptImpl;
...
public final class MinecraftProtocol extends Protocol {
    ...
    MinecraftProtocol enableEncryption(Key key) {
        try {
            this.encrypt = new EncryptImpl(key);
    ...
    public void newSession(Server server, Session session) {
