...
import mc.minicraft.data.game.entity.attribute.Attribute;
import mc.minicraft.data.game.entity.attribute.AttributeModifier;
...
public class ServerEntityPropertiesPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        for (int index = 0; index < length; index++) {
            ...
            for (int ind = 0; ind < len; ind++) {
                modifiers.add(new AttributeModifier(in.readUUID(), in.readDouble(), mc.minicraft.Magic.key(ModifierOperation.class, in.readByte())));
            }

            this.attributes.add(new Attribute(mc.minicraft.Magic.key(AttributeType.class, key), value, modifiers));
        }
    }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        for (Attribute attribute : this.attributes) {
            out.writeString(mc.minicraft.Magic.value(String.class, attribute.getType()));
            ...
            for (AttributeModifier modifier : attribute.getModifiers()) {
                ...
                out.writeByte(mc.minicraft.Magic.value(Integer.class, modifier.getOperation()));
            }
        }
    }
