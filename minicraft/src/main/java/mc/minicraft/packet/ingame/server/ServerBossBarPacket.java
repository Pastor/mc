...
import mc.minicraft.data.game.BossBarAction;
import mc.minicraft.data.game.BossBarColor;
import mc.minicraft.data.game.BossBarDivision;
...
public class ServerBossBarPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minicraft.Magic.key(BossBarAction.class, in.readVarInt());
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            this.color = mc.minicraft.Magic.key(BossBarColor.class, in.readVarInt());
            this.division = mc.minicraft.Magic.key(BossBarDivision.class, in.readVarInt());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == BossBarAction.ADD || this.action == BossBarAction.UPDATE_STYLE) {
            out.writeVarInt(mc.minicraft.Magic.value(Integer.class, this.color));
            out.writeVarInt(mc.minicraft.Magic.value(Integer.class, this.division));
        }
