...
import mc.minicraft.data.game.scoreboard.CollisionRule;
import mc.minicraft.data.game.scoreboard.NameTagVisibility;
import mc.minicraft.data.game.scoreboard.TeamAction;
import mc.minicraft.data.game.scoreboard.TeamColor;
...
public class ServerTeamPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minicraft.Magic.key(TeamAction.class, in.readByte());
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            this.nameTagVisibility = mc.minicraft.Magic.key(NameTagVisibility.class, in.readString());
            this.collisionRule = mc.minicraft.Magic.key(CollisionRule.class, in.readString());
            this.color = mc.minicraft.Magic.key(TeamColor.class, in.readByte());
        }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == TeamAction.CREATE || this.action == TeamAction.UPDATE) {
            ...
            out.writeString(mc.minicraft.Magic.value(String.class, this.nameTagVisibility));
            out.writeString(mc.minicraft.Magic.value(String.class, this.collisionRule));
            out.writeByte(mc.minicraft.Magic.value(Integer.class, this.color));
        }
