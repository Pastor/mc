...
import mc.minicraft.data.game.entity.player.CombatState;
...
public class ServerCombatPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        this.state = mc.minicraft.Magic.key(CombatState.class, in.readVarInt());
    ...
    public void write(Buffer.Output out) throws IOException {
        out.writeVarInt(mc.minicraft.Magic.value(Integer.class, this.state));
        if (this.state == CombatState.END_COMBAT) {
