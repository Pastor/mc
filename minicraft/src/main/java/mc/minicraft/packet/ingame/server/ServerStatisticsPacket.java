...
import mc.minicraft.data.game.statistic.*;
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        for (int index = 0; index < length; index++) {
            ...
            if (value.startsWith("achievement.")) {
                statistic = mc.minicraft.Magic.key(Achievement.class, value);
                ...
                statistic = mc.minicraft.Magic.key(GenericStatistic.class, value);
            }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        for (Statistic statistic : this.statistics.keySet()) {
            ...
            if (statistic instanceof Achievement) {
                value = mc.minicraft.Magic.value(String.class, (Achievement) statistic);
                ...
                value = mc.minicraft.Magic.value(String.class, (GenericStatistic) statistic);
            }
