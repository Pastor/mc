...
import mc.minicraft.data.game.scoreboard.ObjectiveAction;
import mc.minicraft.data.game.scoreboard.ScoreType;
...
public class ServerScoreboardObjectivePacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.action = mc.minicraft.Magic.key(ObjectiveAction.class, in.readByte());
        if (this.action == ObjectiveAction.ADD || this.action == ObjectiveAction.UPDATE) {
            this.displayName = in.readString();
            this.type = mc.minicraft.Magic.key(ScoreType.class, in.readString());
        }
    }
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.action == ObjectiveAction.ADD || this.action == ObjectiveAction.UPDATE) {
            ...
            out.writeString(mc.minicraft.Magic.value(String.class, this.type));
        }
    }
