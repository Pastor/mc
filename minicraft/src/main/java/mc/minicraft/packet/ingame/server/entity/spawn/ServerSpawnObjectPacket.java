...
import mc.minicraft.data.game.entity.type.object.*;
...
public class ServerSpawnObjectPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        this.type = mc.minicraft.Magic.key(ObjectType.class, in.readByte());
        ...
        if (data > 0) {
            if (this.type == ObjectType.MINECART) {
                this.data = mc.minicraft.Magic.key(MinecartType.class, data);
            } else if (this.type == ObjectType.ITEM_FRAME) {
                this.data = mc.minicraft.Magic.key(HangingDirection.class, data);
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        if (this.data != null) {
            if (this.data instanceof MinecartType) {
                data = mc.minicraft.Magic.value(Integer.class, (Enum<?>) this.data);
