...
import mc.minicraft.data.game.world.block.BlockState;
import mc.minicraft.data.game.world.effect.*;
...
public class ServerPlayEffectPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        this.effect = mc.minicraft.Magic.key(WorldEffect.class, in.readInt());
        ...
        if (this.effect == SoundEffect.RECORD) {
            ...
            this.data = mc.minicraft.Magic.key(SmokeEffectData.class, value);
    ...
    public void write(Buffer.Output out) throws IOException {
        out.writeInt(mc.minicraft.Magic.value(Integer.class, this.effect));
        ...
        if (this.data instanceof RecordEffectData) {
            ...
            value = mc.minicraft.Magic.value(Integer.class, (SmokeEffectData) this.data);
