...
import mc.minicraft.data.game.entity.player.BlockBreakStage;
...
public class ServerBlockBreakAnimPacket implements Packet {
    ...
    public void read(Buffer.Input in) throws IOException {
        ...
        try {
            this.stage = mc.minicraft.Magic.key(BlockBreakStage.class, in.readUnsignedByte());
    ...
    public void write(Buffer.Output out) throws IOException {
        ...
        out.writeByte(mc.minicraft.Magic.value(Integer.class, this.stage));
    }
