...
import mc.minicraft.data.game.entity.metadata.MetadataType;
import mc.minicraft.data.game.entity.player.*;
import mc.minicraft.data.game.entity.type.GlobalEntityType;
import mc.minicraft.data.game.entity.type.MobType;
import mc.minicraft.data.game.entity.type.PaintingType;
import mc.minicraft.data.game.entity.type.object.HangingDirection;
import mc.minicraft.data.game.entity.type.object.MinecartType;
import mc.minicraft.data.game.entity.type.object.ObjectType;
import mc.minicraft.data.game.scoreboard.*;
import mc.minicraft.data.game.setting.ChatVisibility;
import mc.minicraft.data.game.setting.Difficulty;
import mc.minicraft.data.game.statistic.Achievement;
import mc.minicraft.data.game.statistic.GenericStatistic;
import mc.minicraft.data.game.window.*;
import mc.minicraft.data.game.window.property.AnvilProperty;
import mc.minicraft.data.game.window.property.BrewingStandProperty;
import mc.minicraft.data.game.window.property.EnchantmentTableProperty;
import mc.minicraft.data.game.window.property.FurnaceProperty;
import mc.minicraft.data.game.world.Particle;
import mc.minicraft.data.game.world.WorldBorderAction;
...
import mc.minicraft.data.game.world.effect.ParticleEffect;
import mc.minicraft.data.game.world.effect.SmokeEffectData;
import mc.minicraft.data.game.world.effect.SoundEffect;
import mc.minicraft.data.game.world.map.MapIconType;
import mc.minicraft.data.game.world.notify.ClientNotification;
import mc.minicraft.data.game.world.notify.DemoMessageValue;
import mc.minicraft.data.game.world.notify.EnterCreditsValue;
...
public final class Magic {
    ...
    static {
        ...
        register(WindowType.GENERIC_INVENTORY, "minicraft:container");
        register(WindowType.ANVIL, "minicraft:anvil");
        register(WindowType.BEACON, "minicraft:beacon");
        register(WindowType.BREWING_STAND, "minicraft:brewing_stand");
        register(WindowType.CHEST, "minicraft:chest");
        register(WindowType.CRAFTING_TABLE, "minicraft:crafting_table");
        register(WindowType.DISPENSER, "minicraft:dispenser");
        register(WindowType.DROPPER, "minicraft:dropper");
        register(WindowType.ENCHANTING_TABLE, "minicraft:enchanting_table");
        register(WindowType.FURNACE, "minicraft:furnace");
        register(WindowType.HOPPER, "minicraft:hopper");
        register(WindowType.VILLAGER, "minicraft:villager");
        register(WindowType.SHULKER_BOX, "minicraft:shulker_box");
